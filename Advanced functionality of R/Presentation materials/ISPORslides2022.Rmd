...
One of the examples is recreated in the [short course GitHub repo](https://github.com/rhart1/Health-Economic-Modeling-in-R_A-Hands-on-Introduction-/blob/main/Advanced%20functionality%20of%20R/hesim%20example%20model.R) (*hesim example model.R* script in the *Advanced functionality of R* folder)
...
## <br><br>Thank you for joining this <br>Virtual ISPOR 2022 Short Course 
