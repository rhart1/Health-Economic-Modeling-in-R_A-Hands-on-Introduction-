...
author: "Rose Hart"
institute: "BresMed Health Solutions Ltd., Sheffield, UK"
date: "17 June 2021"
output:
...
1. The *hesim example model.R* script contains an example model code 

   This is heavily based on the example in the [CRAN vignette](https://cran.r-project.org/web/packages/hesim/vignettes/intro.html) https://cran.r-project.org/web/packages/hesim/vignettes/intro.html 

   We will go through this line by line <br>
...
At it's most basic, a shiny app consists of three scripts:
- app.R 
