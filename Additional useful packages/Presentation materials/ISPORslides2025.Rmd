...
subtitle: "ISPOR EU 2025 - In-person short course"
author: "Rose Hart"
institute: "Senior Health Economist, Covalence Research, UK"
...
output$Results_graph <- renderPlot({
    hesim::autoplot(ictstm()$stateprobs_, labels = labs_indiv,
             ci = FALSE) + ggplot2::theme_bw()
  })
```
...
## <br><br>Thank you for joining this <br>ISPOR EU 2025 Short Course, Glasgow 
