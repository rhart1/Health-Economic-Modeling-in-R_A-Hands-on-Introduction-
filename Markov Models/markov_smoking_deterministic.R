...
transition_matrices <-  array(dim = c(n_treatments, n_states, 
                                      n_states), 
...
# Transitions from not smoking
# These should be the same as the transition probabilities from not smoking for
# SoC with website as the website has no impact on probability of relapse
transition_matrices["SoC", "Not smoking", ] <-  
...
# QALY associated with 1 - year in the smoking state is 0.95
state_qalys["Smoking"] <-  0.95

# QALY associated with 1 - year in the not smoking state is 1 
state_qalys["Not smoking"] <-  1.0 
