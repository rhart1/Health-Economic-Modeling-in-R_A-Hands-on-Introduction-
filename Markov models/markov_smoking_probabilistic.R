...
transition_matrices["SoC with website", , "Smoking", ] <- rdiric(n_samples, c(85, 15))
# Transitions from not smoking
transition_matrices["SoC with website", , "Not smoking", ] <- rdiric(n_samples, c(8, 92))

# Second the transition matrix for Standard of Care
# Transitions from smoking 
transition_matrices["SoC", , "Smoking", ] <- rdiric(n_samples, c(88, 12))
# Transitions from not smoking
