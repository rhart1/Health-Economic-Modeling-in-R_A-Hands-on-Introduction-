...
This document outlines course the structure and pre-read materials for the ISPOR EU 2025 in-person short course entitled "Health Economic Modeling in R: A Hands-on Introduction".

The planned itinerary for the course can be found at [\textcolor{colourblue}{ISPOR short course}](https://www.ispor.org/conferences-education/event/2025/11/09/default-calendar/november-9----health-economic-modeling-in-r--a-hands-on-introduction---in-person-at-ispor-europe-2025).

- 8.00-8.05: Welcome & introductions [***\textcolor{colourblue}{Felicity Lamrock}***](https://pure.qub.ac.uk/en/persons/felicity-lamrock)
- 8.05-9.00: Introduction to R for Health Economics using ([\textcolor{colourblue}{BCEA}](https://github.com/giabaio/BCEA)) [***\textcolor{colourblue}{Gianluca Baio}***](https://www.ucl.ac.uk/statistics/people/gianlucabaio)
- 9.00-10.00: Discrete time Markov models (deterministic) [***\textcolor{colourblue}{Felicity Lamrock}***](https://pure.qub.ac.uk/en/persons/felicity-lamrock)
- 10.00-10.15: **Coffee break**
- 10.15-11.15: Discrete time Markov models (probabilistic) [***\textcolor{colourblue}{Howard Thom}***](https://www.bristol.ac.uk/people/person/Howard-Thom-7d5ace0c-a4eb-4fa0-8c0b-37dc141c0e9f/)
- 11.15-12.00: Additional Useful Packages for R Modelling ([\textcolor{colourblue}{shiny}](https://shiny.rstudio.com/), [\textcolor{colourblue}{hesim}](https://hesim-dev.github.io/hesim/), [\textcolor{colourblue}{rmarkdown}](https://rmarkdown.rstudio.com/)) [***\textcolor{colourblue}{Rose Hart}***](https://github.com/rhart1)
...
These course materials, as well as extensive extended reading, can also be found in our book [\textcolor{colourblue}{R for Health Technology Assessment}](https://www.routledge.com/R-for-Health-Technology-Assessment/Baio-Thom-Pechlivanoglou/p/book/9780367468910?srsltid=AfmBOoqlQCE_8xvu09TIHd__5Teb-GfuQiRxZYj0T5lAn4AISQDO9DTb), which can also be accessed online [\textcolor{colourblue}{here}](https://gianluca.statistica.it/books/online/r-hta/).
...
After setup, our book, [\textcolor{colourblue}{R for Health Technology Assessment}](https://gianluca.statistica.it/books/online/r-hta/), offers HTA-specific teachings and exercises to build and extend on the skills learned in this course. This resource combines health economic principles with practical examples in R, and the online version is updated periodically.
