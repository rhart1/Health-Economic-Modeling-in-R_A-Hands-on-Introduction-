...
This document outlines course the structure and pre-read materials for the ISPOR 2024 in-person short course entitled "Health Economic Modeling in R: A Hands-on Introduction".

The planned itinerary for the course will can be found on [\textcolor{colourblue}{ISPOR short course}](https://www.ispor.org/conferences-education/event/2024/11/17/default-calendar/november-17--health-economic-modeling-in-r--a-hands-on-introduction---in-person-at-ispor-europe-2024) once it has been made available
